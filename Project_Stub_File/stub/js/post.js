...
function comments(cmt){
   ...
   par.appendChild(lis);
   // par.prepend(lis);
    var vs = document.getElementById("listofcomments");
    //vs.appendChild(par);
    vs.prepend(par);
...
function editor(eds)
{
    var vs = document.getElementById("jimiedit");
  ...
  par.style.height = (par.scrollHeight)+"px";
      par1.style.height = (par1.scrollHeight-25)+"px";
        document.getElementById("editbutton").innerHTML ='Save&nbsp;<i class="fas fa-save"></i>'; 
    editone=2;
       ...
       console.log(gun);
        ...
        document.getElementById("blogTitleNew").setAttribute('style','display:block;');
         document.getElementById("editbutton").innerHTML ='Edit&nbsp;<i class="fas fa-edit"></i>';
        editone=1;
